...
export default {
  ...
  methods: {
    // 更新清除按钮显示状态
    updateClearBtn() {
      // 修复：使用trim()确保空字符串或仅含空格的字符串也被视为空
      this.showClearBtn = !this.disabled && this.searchValue && this.searchValue.trim().length > 0;
    ...
    onInput(e) {
	  ...
	  console.log('[输入事件调试] value:', value);
      this.searchValue = value;
	  console.log('[输入事件调试] this.searchValue:', this.searchValue);
      this.updateClearBtn();
